...
<head>
    ...
    <title>Consultation des Compétences</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="text-center mt-3 d-flex justify-content-end">
        <a href="AddSkill.jsp" class="btn btn-success" role="button">Ajouter une compétence</a>
        <br> <br><br>
...
%>
    <table class="table">         		
        ...
        <tbody id="skillsTableBody">
            ...
            %>
                        <tr>
                            <td colspan="5" class="no-competence">Aucune compétence à afficher.</td>
                        </tr>
            <%
                    } else {
            ...
            %>
                            <tr>
                                ...
                                <td><%= skill.getCategorie().getNom() %></td>
                                <td>
                                    <!-- Your action buttons for editing and deleting -->
                                    <div class="d-flex">
                                        <a href="Skillupdate.jsp?nom=<%= skill.getName() %>" class="btn btn-primary btn-sm" role="button">
                                            Éditer
                                        </a><br><br><br>
                                        <a href="CrudSkillservlet?nomsup=<%= skill.getName() %>" class="btn btn-danger btn-sm" role="button">
                                        Supprimer
                                        </a>
